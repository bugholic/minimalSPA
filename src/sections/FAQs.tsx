      ...
      <div className="container">
        ...
        <div className="mt-10 md:mt-16 lg:mt-20">
          {faqs.map(({ question, answer }, faqIndex) => (
            <div
              key={question}
              className="border-t border-stone-400 border-dotted  last:border-b  relative isolate group/faq"
              onClick={() => {
            ...
            >
              <div
                className={twMerge(
                  "absolute h-0 w-full bg-stone-300 -z-10 group-hover/faq:h-full transition-all duration-700",
                  faqIndex === selectedIndex && "h-full"
                )}
              ></div>
              <div
                className={twMerge(
                  "flex justify-between items-center gap-4 py-6 md:py-8 lg:py-10 transition-all duration-700 group-hover/faq:lg:px-8",
              ...
              >
                ...
                <div
                  className={twMerge(
                    "inline-flex items-center justify-center size-11 border border-stone-400 rounded-full shrink-0 transition duration-700 bg-stone-200",
