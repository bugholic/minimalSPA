...
const Hero: FC = () => {
  ...
  // 5 columns out of 12 so 12/5 = 2.4 * 100 = 240
  ...
  return (
    <section>
      <div className="grid md:grid-cols-12 md:h-screen items-strech sticky top-0 -z-10">
      ...
      <div className="md:h-[200vh]" ref={stickyDiv}></div>
    </section>
  );
};
