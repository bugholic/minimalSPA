      ...
      <div className="container">
        ...
        <div className="mt-10 md:mt-16">
          {projects.map(({ name, image }) => (
            <a href="#" key={name}>
              <div className="border-t last:border-b border-dotted flex flex-col border-stone-400 py-6 md:py-8 lg:py-10 relative group/project">
                ...
                <div className="relative">
                  ...
                  <div className="mt-8 flex justify-between items-center md:mt-0 md:grid md:[grid-template-columns:1fr_300px_max-content] md:gap-8">
                    ...
                    <div className="lg:group-hover/project:pr-8">
